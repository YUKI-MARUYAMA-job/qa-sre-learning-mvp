...
| ファイル                                                          | 役割                                  |
| ----------------------------------------------------------------- | ------------------------------------- |
| [data/raw/quiz-questions.json](/data/raw/quiz-questions.json)     | クイズ問題データの正本                |
| [data/raw/subject-taxonomy.json](/data/raw/subject-taxonomy.json) | クイズ分類体系の正本                  |
| [public/study-it/quiz_data.json](/public/study-it/quiz_data.json) | Webアプリが読み込む公開用クイズデータ |
...
- [src/schemas/quiz-question.schema.ts](/src/schemas/quiz-question.schema.ts)
- [src/schemas/subject-taxonomy.schema.ts](/src/schemas/subject-taxonomy.schema.ts)
...
- [e2e/quiz-smoke.e2e.ts](/e2e/quiz-smoke.e2e.ts)
...
- [src/cli/validate-quiz-data.ts](/src/cli/validate-quiz-data.ts)
- [tests/validate-quiz-taxonomy.test.ts](/tests/validate-quiz-taxonomy.test.ts)
...
- [data/raw/quiz-questions.json](/data/raw/quiz-questions.json)
- [data/fixtures/policy-invalid-quiz-questions.json](/data/fixtures/policy-invalid-quiz-questions.json)
...
| ------------------------------------------------------------------------- | ----------------- | ------------------- | ----------------- | ---------------------- |
| [invalid-quiz-schema.json](/invalid-quiz-schema.json)                     | 失敗              | 評価しない          | 評価しない        | 構造不正を検出する     |
| [invalid-quiz-taxonomy.json](/invalid-quiz-taxonomy.json)                 | 成功              | 失敗                | 評価不要          | 分類不整合を検出する   |
| [policy-invalid-quiz-questions.json](/policy-invalid-quiz-questions.json) | 成功              | 成功                | 失敗              | 公開方針違反を検出する |
|||
...
- [data/fixtures/invalid-quiz-schema.json](/data/fixtures/invalid-quiz-schema.json)
- [data/fixtures/invalid-quiz-taxonomy.json](/data/fixtures/invalid-quiz-taxonomy.json)
- [data/fixtures/policy-invalid-quiz-questions.json](/data/fixtures/policy-invalid-quiz-questions.json)
...
| 出力                                                              | 方針                                             |
| ----------------------------------------------------------------- | ------------------------------------------------ |
| [public/study-it/quiz_data.json](/public/study-it/quiz_data.json) | commit対象の生成済み公開用データ                 |
| `dist/app`                                                        | Vite production build output。通常はcommitしない |
| [reports/quiz-quality-report.md](/reports/quiz-quality-report.md) | commit対象の品質レポート                         |
| [test-results/](/test-results/)                                   | Playwright実行結果。通常はcommitしない           |
| [playwright-report/](/playwright-report/)                         | Playwright HTML report。通常はcommitしない       |
|||
...
| data          | [data/raw/quiz-questions.json](/data/raw/quiz-questions.json) が16問構成である                                   |
| data          | 各問題がrepo内部source pathを持つ                                                                                |
| taxonomy      | [data/raw/subject-taxonomy.json](/data/raw/subject-taxonomy.json) がポートフォリオ理解用カテゴリに更新されている |
| fixture       | [data/fixtures/policy-invalid-quiz-questions.json](/data/fixtures/policy-invalid-quiz-questions.json) が存在する |
...
| ------------------------------------------------------------------------------------------- | ----------------------------- |
| [data/raw/quiz-questions.json](/data/raw/quiz-questions.json)                               | クイズ問題データの正本        |
| [data/raw/subject-taxonomy.json](/data/raw/subject-taxonomy.json)                           | 分類体系の正本                |
| [public/study-it/quiz_data.json](/public/study-it/quiz_data.json)                           | 公開用クイズデータ            |
| [src/schemas/quiz-question.schema.ts](/src/schemas/quiz-question.schema.ts)                 | クイズ問題schema              |
| [src/schemas/subject-taxonomy.schema.ts](/src/schemas/subject-taxonomy.schema.ts)           | taxonomy schema               |
| [src/application/validate-quiz-taxonomy.ts](/src/application/validate-quiz-taxonomy.ts)     | taxonomy validation           |
| [src/application/validate-quiz-policy.ts](/src/application/validate-quiz-policy.ts)         | policy validation             |
| [src/cli/validate-quiz-data.ts](/src/cli/validate-quiz-data.ts)                             | クイズデータ検証              |
| [src/cli/validate-quiz-policy.ts](/src/cli/validate-quiz-policy.ts)                         | クイズpolicy検証              |
| [src/cli/validate-quiz-fixtures.ts](/src/cli/validate-quiz-fixtures.ts)                     | fixture責務検証               |
| [src/cli/generate-quiz-report.ts](/src/cli/generate-quiz-report.ts)                         | クイズ品質レポート生成        |
| [src/cli/prepare-public-quiz-data.ts](/src/cli/prepare-public-quiz-data.ts)                 | 公開用クイズデータ生成        |
| [tests/validate-quiz-taxonomy.test.ts](/tests/validate-quiz-taxonomy.test.ts)               | taxonomy validation test      |
| [tests/validate-quiz-policy.test.ts](/tests/validate-quiz-policy.test.ts)                   | policy validation test        |
| [tests/invalid-quiz-schema-fixture.test.ts](/tests/invalid-quiz-schema-fixture.test.ts)     | schema-invalid fixture test   |
| [tests/invalid-quiz-taxonomy-fixture.test.ts](/tests/invalid-quiz-taxonomy-fixture.test.ts) | taxonomy-invalid fixture test |
| [e2e/quiz-smoke.e2e.ts](/e2e/quiz-smoke.e2e.ts)                                             | Playwright E2E                |
| [playwright.config.ts](/playwright.config.ts)                                               | E2E設定                       |
| [reports/quiz-quality-report.md](/reports/quiz-quality-report.md)                           | クイズ品質レポート            |
