...
| 領域               | 対象                                 | 主な導線                                                                                                                                                                                            |
| ------------------ | ------------------------------------ | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| クイズアプリ       | React / Viteによる4択クイズUI        | [src/client/](/src/client/)                                                                                                                                                                         |
| クイズデータ       | raw quiz data、taxonomy、公開用JSON  | [data/raw/quiz-questions.json](/data/raw/quiz-questions.json)、[data/raw/subject-taxonomy.json](/data/raw/subject-taxonomy.json)、[public/study-it/quiz_data.json](/public/study-it/quiz_data.json) |
| クイズ品質レポート | クイズデータの分布・検証結果         | [reports/quiz-quality-report.md](/reports/quiz-quality-report.md)                                                                                                                                   |
| 学習データ         | 品質レポート生成用の学習項目         | [data/raw/learning-items.json](/data/raw/learning-items.json)                                                                                                                                       |
| schema定義         | Zodによる構造検証                    | [src/schemas/](/src/schemas/)                                                                                                                                                                       |
| 検証処理           | validation / report / baseline check | [src/cli/](/src/cli/)、[src/application/](/src/application/)                                                                                                                                        |
| 異常系fixture      | schema、taxonomy、policy違反の検出   | [data/fixtures/](/data/fixtures/)、[tests/](/tests/)                                                                                                                                                |
| E2E                | クイズ操作の主要フロー検証           | [e2e/quiz-smoke.e2e.ts](/e2e/quiz-smoke.e2e.ts)                                                                                                                                                     |
| 品質ゲート         | local / GitHub Actionsでの統合検査   | [.github/workflows/quality-gate.yml](/.github/workflows/quality-gate.yml)                                                                                                                           |
| デプロイ           | Cloudflare Pages向けbuild            | `bun run pages:build`、[dist/app](/dist/app)                                                                                                                                                        |
| 開発環境           | Dev Containerによる再現環境          | [.devcontainer/](/.devcontainer/)                                                                                                                                                                   |
| ドキュメント       | 設計・受け入れ基準・面接説明         | [README.md](/README.md)、[docs/](/docs/) 、[reports/](/reports/)                                                                                                                                    |
|||
...
| 確認項目       | 合格条件                                                                     | 確認方法                                                                                   |
| -------------- | ---------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------ |
| raw data       | [data/raw/quiz-questions.json](/data/raw/quiz-questions.json) が存在する     | ファイル確認                                                                               |
| taxonomy       | [data/raw/subject-taxonomy.json](/data/raw/subject-taxonomy.json) が存在する | ファイル確認                                                                               |
| 問題数         | 現行MVPでは16問を含む                                                        | `bun run validate:quiz`、[reports/quiz-quality-report.md](/reports/quiz-quality-report.md) |
...
- [src/cli/prepare-public-quiz-data.ts](/src/cli/prepare-public-quiz-data.ts)
- [src/cli/validate-quiz-data.ts](/src/cli/validate-quiz-data.ts)
- [src/cli/validate-quiz-policy.ts](/src/cli/validate-quiz-policy.ts)
- [src/application/validate-quiz-taxonomy.ts](/src/application/validate-quiz-taxonomy.ts)
- [src/application/validate-quiz-policy.ts](/src/application/validate-quiz-policy.ts)
...
| 確認項目      | 合格条件                                                                 | 確認方法                  |
| ------------- | ------------------------------------------------------------------------ | ------------------------- |
| 学習データ    | [data/raw/learning-items.json](/data/raw/learning-items.json) が存在する | ファイル確認              |
...
- [data/raw/learning-items.json](/data/raw/learning-items.json)
- [src/schemas/learning-item.schema.ts](/src/schemas/learning-item.schema.ts)
- [src/application/validate-source-policy.ts](/src/application/validate-source-policy.ts)
- [src/cli/validate-data.ts](/src/cli/validate-data.ts)
...
| 確認項目     | 合格条件                                                     | 確認方法                                              |
| ------------ | ------------------------------------------------------------ | ----------------------------------------------------- |
| fixture配置  | [data/fixtures/](/data/fixtures/) に異常系fixtureが存在する  | ファイル確認                                          |
...
- [tests/invalid-fixture.test.ts](/tests/invalid-fixture.test.ts)
- [tests/invalid-quiz-schema-fixture.test.ts](/tests/invalid-quiz-schema-fixture.test.ts)
- [tests/invalid-quiz-taxonomy-fixture.test.ts](/tests/invalid-quiz-taxonomy-fixture.test.ts)
- [tests/invalid-quiz-fixture.test.ts](/tests/invalid-quiz-fixture.test.ts)
- [tests/validate-quiz-policy.test.ts](/tests/validate-quiz-policy.test.ts)
- [src/cli/validate-quiz-fixtures.ts](/src/cli/validate-quiz-fixtures.ts)
...
| 確認項目               | 合格条件                                                                     | 確認方法                                                          |
| ---------------------- | ---------------------------------------------------------------------------- | ----------------------------------------------------------------- |
| 学習データ品質レポート | [reports/quality-report.md](/reports/quality-report.md) が生成される         | `bun run report`                                                  |
| クイズ品質レポート     | [reports/quality-report.md](/reports/quality-report.md) が生成される         | `bun run quiz:report`                                             |
| 提出準備レポート       | [reports/portfolio-readiness.md](/reports/portfolio-readiness.md) が存在する | ファイル確認                                                      |
...
| クイズ分布             | 16問、新track、新category、新publisher分布が反映されている                   | [reports/quiz-quality-report.md](/reports/quiz-quality-report.md) |
|||

関連ファイル:

- [reports/quality-report.md](/reports/quality-report.md)
...
- [src/cli/generate-report.ts](/src/cli/generate-report.ts)
- [src/cli/generate-quiz-report.ts](/src/cli/generate-quiz-report.ts)
...
- [bun.lock](/bun.lock)
- [src/cli/check-dependency-policy.ts](/src/cli/check-dependency-policy.ts)
- [scripts/check-public-safety.sh](/scripts/check-public-safety.sh)
...
| CI実行     | GitHub Actionsで同じ品質ゲートが成功する        | [github/workflows/quality-gate.yml](/github/workflows/quality-gate.yml) |
...
- [src/cli/check-security-baseline.ts](/src/cli/check-security-baseline.ts)
- [src/cli/check-performance-baseline.ts](/src/cli/check-performance-baseline.ts)
- [site/static/\_headers](/site/static/_headers)
...
| 確認項目     | 合格条件                                                   | 確認方法                          |
| ------------ | ---------------------------------------------------------- | --------------------------------- |
| 設定ファイル | Dev Container設定が存在する                                | [.devcontainer/](/.devcontainer/) |
...
| 確認項目       | 合格条件                                                                    | 主な導線                                                                            |
| -------------- | --------------------------------------------------------------------------- | ----------------------------------------------------------------------------------- |
| README         | プロジェクト概要、公開URL、機能、技術構成、品質ゲート、デプロイ手順が分かる | [README.md](/README.md)                                                             |
| アーキテクチャ | データ境界、検証層、デプロイ責務が分かる                                    | [docs/architecture/architecture.md](/docs/architecture/architecture.md)             |
| 受け入れ基準   | MVPとしての合格条件が分かる                                                 | [docs/acceptance-criteria.md](/docs/acceptance-criteria.md)                         |
| 面接説明       | 技術判断と説明ポイントが分かる                                              | [docs/interview/quiz-app-explanation.md](/docs/interview/quiz-app-explanation.md)   |
| クイズ検証方針 | schema / taxonomy / policy validationの方針が分かる                         | [docs/quiz-schema-taxonomy-validation.md](/docs/quiz-schema-taxonomy-validation.md) |
| 品質レポート   | 検証結果と提出準備状況が分かる                                              | [reports/](/reports/)                                                               |
|||
...
| 確認項目     | 合格条件                                         | 確認方法                                                      |
| ------------ | ------------------------------------------------ | ------------------------------------------------------------- |
| 同期診断     | Git同期状態を確認するscriptが存在する            | [scripts/git-sync-diagnose.sh](/scripts/git-sync-diagnose.sh) |
...
- [x] `bun run validate:data` が成功する
- [x] `bun run validate:policy` が成功する
- [x] `bun run validate:quiz` が成功する
- [x] `bun run validate:quiz-policy` が成功する
- [x] `bun run validate:quiz-fixtures` が成功する

### 型検査・テスト

- [x] `bun run typecheck` が成功する
- [x] `bun run client:typecheck` が成功する
- [x] `bun run test:unit` が成功する
- [x] `CI=1 bunx playwright test e2e/quiz-smoke.e2e.ts --trace on` が成功する

### 生成物

- [x] `bun run report` が成功する
- [x] `bun run quiz:report` が成功する
- [x] `bun run report:check` が成功する
- [x] `bun run quiz:report:check` が成功する
- [x] `bun run prepare:public-quiz-data:check` が成功する
- [x] [reports/quiz-quality-report.md](/reports/quiz-quality-report.md) が16問構成を反映している
- [x] [public/study-it/quiz_data.json](/public/study-it/quiz_data.json) が16問構成を反映している

### build・baseline

- [x] `bun run client:build` が成功する
- [x] `bun run site:check` が成功する
- [x] `bun run validate:security-baseline` が成功する
- [x] `bun run validate:performance-baseline` が成功する

### 統合品質ゲート

- [x] `CI=1 bun run check` が成功する
- [x] GitHub Actions `quality-gate` がpull request上で成功する
- [x] GitHub Actions `quality-gate` がmain push後に成功する

### デプロイ

- [x] Cloudflare Pagesでクイズアプリを確認できる
- [x] `bun run pages:build` が成功する
- [x] `dist/app` が生成される

### ドキュメント

- [x] [README.md](/README.md) が存在する
- [x] [docs/architecture/architecture.md](/docs/architecture/architecture.md) が存在する
- [x] [docs/acceptance-criteria.md](/docs/acceptance-criteria.md) が存在する
- [x] [docs/interview/quiz-app-explanation.md](/docs/interview/quiz-app-explanation.md) が存在する
- [x] [docs/quiz-schema-taxonomy-validation.md](/docs/quiz-schema-taxonomy-validation.md) が存在する
- [x] READMEから主要docsへ辿れる
- [x] READMEから主要reportsへ辿れる
- [x] クイズが外部試験問題対策ではないことが明記されている

### 開発環境

- [x] Dev Container内で `bun` が利用できる
- [x] Dev Container内で `bunx` が利用できる
- [x] Dev Container内で主要検証が成功する
