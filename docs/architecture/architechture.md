...
この流れでは、`data/raw/quiz-questions.json` を内部的な正本とし、検証済みの表示用データだけを `public/study-it/quiz_data.json` として生成します。
...
| 正本     | `data/raw/quiz-questions.json`                                            |
| 分類体系   | `data/raw/subject-taxonomy.json`                                          |
| 公開用データ | `public/study-it/quiz_data.json`                                          |
| source | `README.md`、`docs/`、`reports/`、`src/`、`e2e/`、`package.json` などのrepo内部path |
...
| Fixture                                            | 期待される挙動                                                 |
| -------------------------------------------------- | ------------------------------------------------------- |
| `data/fixtures/invalid-quiz-schema.json`           | schema validationで失敗する                                  |
| `data/fixtures/invalid-quiz-taxonomy.json`         | schema validationは通過し、taxonomy validationで失敗する          |
| `data/fixtures/policy-invalid-quiz-questions.json` | schema / taxonomy validationは通過し、policy validationで失敗する |
...
| 出力先                              | 内容                    | commit方針    |
| -------------------------------- | --------------------- | ----------- |
| `dist/app`                       | React / Viteによるクイズアプリ | 原則commitしない |
| `dist/site`                      | 品質レポート用の静的サイト         | 原則commitしない |
| `reports/quality-report.md`      | 学習データの品質レポート          | commit対象    |
| `reports/quiz-quality-report.md` | クイズデータの品質レポート         | commit対象    |
| `public/study-it/quiz_data.json` | クイズアプリが読み込む公開用JSON    | commit対象    |
...
| `reports/quality-report.md`               | 学習データの品質レポート  |
