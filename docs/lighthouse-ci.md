...
| 設定                                            | 測定対象    | 目的                                   |
| ----------------------------------------------- | ----------- | -------------------------------------- |
| [lighthouserc.json](/lighthouserc.json)         | `dist/site` | 静的レポートサイトの補助観測           |
| [lighthouserc.app.json](/lighthouserc.app.json) | `dist/app`  | React / Viteクイズアプリ本体の補助観測 |
...
[lighthouserc.app.json](/lighthouserc.app.json)
...
Lighthouse CIをwarn-onlyで運用する理由を以下に示します。
...
- [.github/workflows/lighthouse-app-warn.yml](/.github/workflows/lighthouse-app-warn.yml)
...
| Workflow                                                                                | 役割                                         | 失敗時の扱い           |
| --------------------------------------------------------------------------------------- | -------------------------------------------- | ---------------------- |
| [.github/workflows/quality-gate.yml](/.github/workflows/quality-gate.yml)               | 必須品質ゲートを実行します                   | 修正対象               |
| [.github/workflows/lighthouse-warn.yml](/.github/workflows/lighthouse-warn.yml)         | 静的レポートサイトのブラウザ品質を観測します | 改善候補として扱います |
| [.github/workflows/lighthouse-app-warn.yml](/.github/workflows/lighthouse-app-warn.yml) | クイズアプリ本体のブラウザ品質を観測します   | 改善候補として扱います |
...
| ファイル                                                                                | 役割                                          |
| --------------------------------------------------------------------------------------- | --------------------------------------------- |
| [lighthouserc.json](/lighthouserc.json)                                                 | 静的レポートサイト向けLighthouse CI設定       |
| [lighthouserc.app.json](/lighthouserc.app.json)                                         | クイズアプリ本体向けLighthouse CI設定         |
| [.github/workflows/lighthouse-warn.yml](/.github/workflows/lighthouse-warn.yml)         | 静的レポートサイト向けwarn-only workflow      |
| [.github/workflows/lighthouse-app-warn.yml](/.github/workflows/lighthouse-app-warn.yml) | クイズアプリ本体向けwarn-only workflow        |
| [package.json](/package.json)                                                           | `lighthouse:*` scripts定義                    |
| [site/](/site/)                                                                         | 静的レポートサイトのsource                    |
| [src/client/](/src/client/)                                                             | React / Viteクイズアプリ                      |
| [public/study-it/quiz_data.json](/public/study-it/quiz_data.json)                       | クイズアプリが読み込む公開用JSON              |
