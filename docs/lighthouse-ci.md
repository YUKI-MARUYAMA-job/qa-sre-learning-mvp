...
| Workflow                                                                                | 役割                                         | 失敗時の扱い           |
| --------------------------------------------------------------------------------------- | -------------------------------------------- | ---------------------- |
| [.github/workflows/quality-gate.yml](/.github/workflows/quality-gate.yml)               | 必須品質ゲートを実行する                   | 修正対象               |
| [.github/workflows/lighthouse-warn.yml](/.github/workflows/lighthouse-warn.yml)         | 静的レポートサイトのブラウザ品質を観測する | 改善候補として扱う|
| [.github/workflows/lighthouse-app-warn.yml](/.github/workflows/lighthouse-app-warn.yml) | クイズアプリ本体のブラウザ品質を観測する | 改善候補として扱う |
|||
