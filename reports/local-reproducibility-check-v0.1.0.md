...
`reports/local-reproducibility-check-v0.1.0.md`
...
| ------------------------------------ | -------------- | ----------------------------------- |
| `invalid-quiz-schema.json`           | schema         | fail at schema                      |
| `invalid-quiz-taxonomy.json`         | taxonomy       | pass schema, fail taxonomy          |
| `policy-invalid-quiz-questions.json` | policy         | pass schema / taxonomy, fail policy |
...
| -------------------------------- | ---------------------------------------- |
| `reports/quiz-quality-report.md` | `bun run quiz:report:check`              |
| `public/study-it/quiz_data.json` | `bun run prepare:public-quiz-data:check` |
| `reports/quality-report.md`      | `bun run report:check`                   |
