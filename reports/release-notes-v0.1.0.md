...
| 変更単位               | 主な内容                                                                             | 目的                                                             |
| ---------------------- | ------------------------------------------------------------------------------------ | ---------------------------------------------------------------- |
| 検索露出制御           | `robots.txt`、`meta noindex`、`X-Robots-Tag`、Cloudflare Pages向け `_headers` を整備 | 公開demoの検索engine indexを抑制する                             |
...
| Lighthouse補助観測     | `lighthouserc.app.json` とPlaywright Chromiumを使う補助scriptを追加                  | devcontainer内でもブラウザ品質観測を再現可能にする               |
...
| `src/client/components/QuizCard.tsx`                     | クイズカードと選択肢buttonの描画                          |
...
| `public/robots.txt`                                      | crawler巡回抑制方針                                       |
| `public/_headers`                                        | Cloudflare Pages向けsecurity header / `X-Robots-Tag` 設定 |
...
| `docs/troubleshooting/devcontainer-lighthouse-chrome.md` | devcontainer内Lighthouse Chromeトラブルシューティング     |
| `docs/troubleshooting/github-actions-allowlist.md`       | GitHub Actions allowlistトラブルシューティング            |
...
| `scripts/run-lhci-app-with-playwright-chromium.mjs`      | devcontainer向けLighthouse実行補助script                  |
