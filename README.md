...
| `docs/llm-assisted-development.md`              | LLMをどの範囲で活用し、どの品質保証を本人が担保したかを説明する文書                                                                  |
| `docs/interview-notes.md`                       | 面接説明用の補助資料                                                                                                                 |
| `reports/quality-report.md`                     | 学習データの品質・source policy検証結果                                                                                              |
| `reports/quiz-quality-report.md`                | クイズデータの分布・検証結果                                                                                                         |
| `reports/portfolio-readiness.md`                | ポートフォリオ提出準備状況                                                                                                           |
| `reports/local-reproducibility-check-v0.1.0.md` | ローカル環境で新規clone後に依存関係install、データ生成、build、品質ゲート、E2E、Lighthouse補助観測が再現できることを確認したレポート |
